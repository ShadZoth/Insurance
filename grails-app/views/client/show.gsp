	...
	<body>
		...
		<div id="show-client" class="content scaffold-show" role="main">
			...
			<ol class="property-list client">
				...
				<li class="fieldcontain">
					<span id="registrationDate-label" class="property-label"><g:message code="client.registrationDate.label" default="Registration Date" /></span>
					
						<span class="property-value" aria-labelledby="registrationDate-label"><g:formatDate date="${clientInstance?.registrationDate}" /></span>
				...
				<li class="fieldcontain">
					<span id="archived-label" class="property-label"><g:message code="client.archived.label" default="Archived" /></span>
					
						<span class="property-value" aria-labelledby="archived-label"><g:formatBoolean boolean="${clientInstance?.archived}" /></span>
					
				</li>
				</g:if>
			
				<g:if test="${clientInstance?.dispatcher}">
				<li class="fieldcontain">
					<span id="dispatcher-label" class="property-label"><g:message code="client.dispatcher.label" default="Dispatcher" /></span>
					
						<span class="property-value" aria-labelledby="dispatcher-label"><g:link controller="user" action="show" id="${clientInstance?.dispatcher?.id}">${clientInstance?.dispatcher?.encodeAsHTML()}</g:link></span>
