...
<body>
<a href="#show-client" class="skip" tabindex="-1"><g:message
            ...
            <li class="fieldcontain">
                <span id="registrationDate-label"
                      class="property-label"><g:message
                        code="client.registrationDate.label"
        ...
        <g:form url="[resource: clientInstance, action: 'delete']"
            ...
            <fieldset class="buttons">
                <g:link class="edit" action="edit"
                        resource="${clientInstance}"><g:message
