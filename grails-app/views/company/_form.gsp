...
<div class="fieldcontain ${hasErrors(bean: companyInstance, field: 'inn', 'error')} required">
    ...
    <g:textField name="inn" maxlength="12" required=""
                 value="${companyInstance?.inn}"/>
    ...
    <ul class="one-to-many">
        ...
        <li class="add">
            <g:link controller="contact" action="create"
                    params="['company.id': companyInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'contact.label', default: 'Contact')])}</g:link>
        </li>
    </ul>
    ...
    <ul class="one-to-many">
        ...
        <li class="add">
            <g:link controller="vehicle" action="create"
                    params="['company.id': companyInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'vehicle.label', default: 'Vehicle')])}</g:link>
        </li>
    </ul>
    ...
    <ul class="one-to-many">
        ...
        <li class="add">
            <g:link controller="warrant" action="create"
                    params="['company.id': companyInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'warrant.label', default: 'Warrant')])}</g:link>
        </li>
    </ul>
