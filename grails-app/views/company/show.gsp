		...
		<div id="show-company" class="content scaffold-show" role="main">
			...
			<ol class="property-list company">
				...
				<li class="fieldcontain">
					<span id="registrationDate-label" class="property-label"><g:message code="company.registrationDate.label" default="Registration Date" /></span>
					
						<span class="property-value" aria-labelledby="registrationDate-label"><g:formatDate date="${companyInstance?.registrationDate}" /></span>
				...
				<li class="fieldcontain">
					<span id="archived-label" class="property-label"><g:message code="company.archived.label" default="Archived" /></span>
					
						<span class="property-value" aria-labelledby="archived-label"><g:formatBoolean boolean="${companyInstance?.archived}" /></span>
				...
				<li class="fieldcontain">
					<span id="seller-label" class="property-label"><g:message code="company.seller.label" default="Seller" /></span>
						...
						<span class="property-value" aria-labelledby="seller-label"><g:link controller="user" action="show" id="${companyInstance?.seller?.id}">${companyInstance?.seller?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="inn-label" class="property-label"><g:message code="company.inn.label" default="Inn" /></span>
						...
						<span class="property-value" aria-labelledby="inn-label"><g:fieldValue bean="${companyInstance}" field="inn"/></span>
				...
				<li class="fieldcontain">
					<span id="vehicles-label" class="property-label"><g:message code="company.vehicles.label" default="Vehicles" /></span>
				...
				<li class="fieldcontain">
					<span id="warrants-label" class="property-label"><g:message code="company.warrants.label" default="Warrants" /></span>
