...
<head>
    ...
    <title><g:message code="contact.create.label"/></title>
</head>
...
<div id="create-contact" class="content scaffold-create" role="main">
    <h1><g:message code="contact.create.label"/></h1>
    ...
    <g:form url="[resource: contactInstance, contactClientId: contactClientId, action: 'save']">
        <fieldset class="form">
