    ...
    <div class="nav" role="navigation">
        <ul>
            <li><g:link class="list" action="index"><g:message
                    code="license.list.label"/></g:link></li>
            <li><g:link class="create" action="create"><g:message
                    code="license.create.label"/></g:link></li>
        </ul>
    </div>
</sec:ifAnyGranted>
...
<div id="show-license" class="content scaffold-show" role="main">
    ...
    <ol class="property-list license">
        ...
        <g:if test="${licenseInstance?.owner}">
            <li class="fieldcontain">
                <span id="owner-label" class="property-label"><g:message
                        code="license.owner.label"
                        default="Owner"/></span>

                <span class="property-value"
                      aria-labelledby="owner-label"><g:link controller="person"
                                                            action="show"
        ...
        <g:if test="${licenseInstance?.expirationDate}">
            <li class="fieldcontain">
                <span id="expirationDate-label"
                      class="property-label"><g:message
                        code="license.expirationDate.label"
                        default="Expiration Date"/></span>

                <span class="property-value"
                      aria-labelledby="expirationDate-label"><g:formatDate
                        format="yyyy-MM-dd"
        ...
        <g:if test="${licenseInstance?.a}">
            <li class="fieldcontain">
                <span id="a-label" class="property-label"><g:message
                        code="license.a.label" default="A"/></span>

                <span class="property-value"
                      aria-labelledby="a-label"><g:formatBoolean
        ...
        <g:if test="${licenseInstance?.b}">
            <li class="fieldcontain">
                <span id="b-label" class="property-label"><g:message
                        code="license.b.label" default="B"/></span>

                <span class="property-value"
                      aria-labelledby="b-label"><g:formatBoolean
        ...
        <g:if test="${licenseInstance?.c}">
            <li class="fieldcontain">
                <span id="c-label" class="property-label"><g:message
                        code="license.c.label" default="C"/></span>

                <span class="property-value"
                      aria-labelledby="c-label"><g:formatBoolean
        ...
        <g:if test="${licenseInstance?.d}">
            <li class="fieldcontain">
                <span id="d-label" class="property-label"><g:message
                        code="license.d.label" default="D"/></span>

                <span class="property-value"
                      aria-labelledby="d-label"><g:formatBoolean
        ...
        <g:if test="${licenseInstance?.e}">
            <li class="fieldcontain">
                <span id="e-label" class="property-label"><g:message
                        code="license.e.label" default="E"/></span>

                <span class="property-value"
                      aria-labelledby="e-label"><g:formatBoolean
        ...
        <g:if test="${licenseInstance?.tb}">
            <li class="fieldcontain">
                <span id="tb-label" class="property-label"><g:message
                        code="license.tb.label" default="Tb"/></span>

                <span class="property-value"
                      aria-labelledby="tb-label"><g:formatBoolean
        ...
        <g:if test="${licenseInstance?.tm}">
            <li class="fieldcontain">
                <span id="tm-label" class="property-label"><g:message
                        code="license.tm.label" default="Tm"/></span>

                <span class="property-value"
                      aria-labelledby="tm-label"><g:formatBoolean
    ...
    <sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SELLER">
        <g:form url="[resource: licenseInstance, action: 'delete']"
                method="DELETE">
            <fieldset class="buttons">
                <g:link class="edit" action="edit"
                        resource="${licenseInstance}"><g:message
