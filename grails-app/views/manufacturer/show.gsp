...
<body>
<a href="#show-manufacturer" class="skip" tabindex="-1"><g:message
    ...
    <div class="nav" role="navigation">
        <ul>
            ...
            <li><g:link class="list" action="index"><g:message
                    code="manufacturer.list.label"/></g:link></li>
            <li><g:link class="create" action="create"><g:message
                    code="manufacturer.create.label"/></g:link></li>
        </ul>
    </div>
</sec:ifAnyGranted>
...
<div id="show-manufacturer" class="content scaffold-show" role="main">
        ...
        <g:if test="${manufacturerInstance?.vehicles}">
            <li class="fieldcontain">
                <span id="vehicles-label" class="property-label"><g:message
                        code="manufacturer.vehicles.label"
    ...
    <sec:ifAnyGranted roles="ROLE_ADMIN">
        <g:form url="[resource: manufacturerInstance, action: 'delete']"
                method="DELETE">
            <fieldset class="buttons">
                <g:link class="edit" action="edit"
                        resource="${manufacturerInstance}"><g:message
