...
%{--Ссылка на добавление контактов--}%
    ...
    <ul class="one-to-many">
        ...
        <li class="add">
            <g:link controller="contact" action="create"
                    params="['person.id': personInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'contact.label', default: 'Contact')])}</g:link>
        </li>
    </ul>

</div>

%{--Ссылка на добавление автомобильных прав--}%
<div class="fieldcontain ${hasErrors(bean: personInstance, field: 'licenses', 'error')} ">
    ...
    <ul class="one-to-many">
        <g:each in="${personInstance?.licenses ?}" var="l">
            <li><g:link controller="license" action="show"
                        id="${l.id}">${l?.encodeAsHTML()}</g:link></li>
        </g:each>
        <li class="add">
            <g:link controller="license" action="create"
                    params="['person.id': personInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'license.label', default: 'License')])}</g:link>
        </li>
    </ul>
...
%{--Ссылка на добавление паспортов--}%
<div class="fieldcontain ${hasErrors(bean: personInstance, field: 'passports', 'error')} ">
    ...
    <ul class="one-to-many">
        <g:each in="${personInstance?.passports ?}" var="p">
            <li><g:link controller="passport" action="show"
                        id="${p.id}">${p?.encodeAsHTML()}</g:link></li>
        </g:each>
        <li class="add">
            <g:link controller="passport" action="create"
                    params="['person.id': personInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'passport.label', default: 'Passport')])}</g:link>
        </li>
    </ul>

</div>

%{--Ссылка на добавление ТС--}%
<div class="fieldcontain ${hasErrors(bean: personInstance, field: 'vehicles', 'error')} ">
    ...
    <ul class="one-to-many">
        <g:each in="${personInstance?.vehicles ?}" var="v">
            <li><g:link controller="vehicle" action="show"
                        id="${v.id}">${v?.encodeAsHTML()}</g:link></li>
        </g:each>
        <li class="add">
            <g:link controller="vehicle" action="create"
                    params="['person.id': personInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'vehicle.label', default: 'Vehicle')])}</g:link>
        </li>
    </ul>

</div>

%{--Ссылка на добавление страховок--}%
<div class="fieldcontain ${hasErrors(bean: personInstance, field: 'warrants', 'error')} ">
    ...
    <ul class="one-to-many">
        <g:each in="${personInstance?.warrants ?}" var="w">
            <li><g:link controller="warrant" action="show"
                        id="${w.id}">${w?.encodeAsHTML()}</g:link></li>
        </g:each>
        <li class="add">
            <g:link controller="warrant" action="create"
                    params="['person.id': personInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'warrant.label', default: 'Warrant')])}</g:link>
        </li>
    </ul>
