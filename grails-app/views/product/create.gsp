...
<head>
    ...
    <title><g:message code="product.create.label" default="New product"/></title>
</head>
...
<div class="nav" role="navigation">
    <ul>
        <li><g:link class="list" action="index"><g:message
                code="product.list.label" default="Product list"/></g:link></li>
    </ul>
</div>

<div id="create-product" class="content scaffold-create" role="main">
    <h1><g:message code="product.create.label" default="New product"/></h1>
