...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'authority', 'error')} required">
	...
	<g:select name="authority" from="${userInstance.constraints.authority.inList}" required="" value="${userInstance?.authority}" valueMessagePrefix="user.authority"/>
...
%{--</g:each>--}%
%{--<li class="add">--}%
%{--<g:link controller="client" action="create" params="['user.id': userInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'client.label', default: 'Client')])}</g:link>--}%
%{--</li>--}%
%{--</ul>--}%
